                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                                    ...
                                                    <select class ="form-control" name='employee'>
                                                        ...
                                                        <?php
                                                                ...
                                                                while ($rows = mysqli_fetch_array($result)){
                                                                    echo "<option value=".$rows['id'] .">" .$rows['Employee_fullname'] . '</option>';
                                                                }                                                     
                                                        ?>
                                                    </select> 
                                                    </div>
                                        ...
                                        <button type="submit"name ="submit" name = "values" class="btn btn-info btn-fill pull-right">Save Profile</button>
                                                            </div>
                                    </form>
                                </div>
                            </div>
